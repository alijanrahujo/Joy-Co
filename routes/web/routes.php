...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode', 'guestCheck']], function () {
    ...
    Route::controller(UserProfileController::class)->group(function () {
        ...
        Route::get('edit-user-account', 'edit_user_account')->name('edit-user-account')->middleware('customer');
        ...
        Route::get('account-address-view', 'account_address_view')->name('account-address-view');
        ...
        Route::get('user-password', 'user_password')->name('user-password')->middleware('customer');
        Route::post('user-password-update', 'user_password_update')->name('user-password-update')->middleware('customer');
        Route::get('gift-cards', 'gift_cards')->name('gift-cards')->middleware('customer');
         Route::get('preferences', 'preferences')->name('preferences')->middleware('customer');
    });
    ...
    Route::get('payment-methods', 'UserWalletController@payment_methods')->name('payment-methods')->middleware('customer');
    Route::get('new-payment-methods', 'UserWalletController@new_payment_methods')->name('new-payment-methods')->middleware('customer');
    ...
    Route::controller(UserLoyaltyController::class)->group(function () {
        ...
        Route::get('about-loyalty', 'about_loyalty')->name('about-loyalty')->middleware('customer');
    });
