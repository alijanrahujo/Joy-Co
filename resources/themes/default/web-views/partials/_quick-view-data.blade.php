...
<div class="modal-header rtl">
    <div>
        <h4 class="modal-title product-title fs-5">
        ...
        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3 web-direction">
            <div class="details __h-100">
                ...
                <div class="d-flex flex-wrap align-items-center mb-2 pro">
                    ...
                    <span class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'me-1 ms-md-2 ms-1 pe-md-2 pe-sm-1 ps-md-2 ps-sm-1' : 'ms-1 me-md-2 me-1 ps-md-2 ps-sm-1 pe-md-2 pe-sm-1'}}"><span class="web-text-primary">{{$overallRating[1]}}</span> {{translate('reviews')}}</span>
                    <span class="__inline-25"></span>
                    <span class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'me-1 ms-md-2 ms-1 pe-md-2 pe-sm-1 ps-md-2 ps-sm-1' : 'ms-1 me-md-2 me-1 ps-md-2 ps-sm-1 pe-md-2 pe-sm-1'}}">
                        <span class="web-text-primary">
                            {{$countOrder}}
                        </span> {{translate('orders')}}   </span>
                    <span class="__inline-25">    </span>
                    <span class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'me-1 ms-md-2 ms-0 pe-md-2 pe-sm-1 ps-md-2 ps-sm-1' : 'ms-1 me-md-2 me-0 ps-md-2 ps-sm-1 pe-md-2 pe-sm-1'}} text-capitalize">
                ...
                <form id="add-to-cart-form" class="mb-2">
                    ...
                    <div class="position-relative {{Session::get('direction') === "rtl" ? 'ms-n4' : 'me-n4'}} mb-3">
