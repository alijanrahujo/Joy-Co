<div class="panel border summary p-3 p-md-5 mt-5">
    ...
    <div class="heading-area pt-0 pb-4">
                <h1>Order Summary</h1>
    </div>
...
<p class="text-end mt-3">By registering your details you agree to our Terms and Conditions and Privacy and Cookie Policy</p>
<div class="row mt-5">
    <div class="col-md-6"></div>
    <div class="col-md-6">
        <button type="button" class="main-btnreverse w-100 text-center proceed_to_next_button {{$cart->count() <= 0 ? 'disabled' : ''}} action-checkout-function">cONTINUE TO PAYMENT</button>
    </div>
</div>
@push('script')
    <script>
