...
<p class="text-end mt-3">You can review and confirm your order in the next step</p>
<div class="row mt-5">
    <div class="col-md-6"></div>
    <div class="col-md-6">
        <button type="button" class="main-btnreverse w-100 text-center proceed_to_next_button {{$cart->count() <= 0 ? 'disabled' : ''}} action-checkout-function">checkout security</button>
    </div>
</div>
