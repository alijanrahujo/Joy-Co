...
class WebController extends Controller
{
    ...
    public function getgifts(Request $request)//: View|RedirectResponse
    {
        return view(VIEW_FILE_NAMES['gifts_view']);
    }


    public function getBlogs(Request $request)//: View|RedirectResponse
    {
        return view(VIEW_FILE_NAMES['blogs_view']);
    }
